...
export default function Home() {
  return (
    <main className="min-h-screen w-full relative">
      {/* hero section */}
      <section className="flex mt-[128px] w-full justify-center flex-col md:flex-row">
        <div className="relative border-red-50 flex-1 flex flex-col text-center max-w-[700px] gap-4">
          <TypographyExtraLarge>
            ...
            <motion.p initial={{ x: -50, opacity: 0, dur: 2 }} animate={{ x: 0, opacity: 1 }} >
          ...
          <TypographyLarge>
            <motion.p initial={{ x: -50, opacity: 0 }} animate={{
              x: 0, opacity: 100, transition: {
                delay: 1,
                ease: 'easeOut'
              }
            }}>Your one-stop destination for all things fabulous.</motion.p>
          </TypographyLarge>
        </div>
      </section>
    </main>
